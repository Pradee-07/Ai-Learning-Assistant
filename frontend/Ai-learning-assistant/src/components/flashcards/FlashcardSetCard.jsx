...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  return (
    <div 
      className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 cursor-pointer flex flex-col h-full"
      onClick={handleStudyNow}
    >
      <div className="space-y-4 flex-1">
        {/* Icon and Title */}
        <div className="flex items-start gap-4">
          <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100 flex items-center justify-center border border-emerald-200/50">
      ...
      <div className="mt-6 pt-4 border-t border-slate-100">
        <button
          ...
          className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-100 hover:from-emerald-600 hover:to-teal-600 text-emerald-700 hover:text-white font-semibold text-sm rounded-xl overflow-hidden transition-all duration-200 shadow-sm active:scale-95 flex items-center justify-center gap-2"
        >
