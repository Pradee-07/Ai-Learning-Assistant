...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  const documentTitle = typeof documentRef === "object" ? documentRef?.title : flashcardSet.title;
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-slate-100">
        <button
          ...
          disabled={!documentId}
          className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-100 hover:from-emerald-600 hover:to-teal-600 text-emerald-700 hover:text-white font-semibold text-sm rounded-xl overflow-hidden transition-all duration-200 shadow-sm active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
